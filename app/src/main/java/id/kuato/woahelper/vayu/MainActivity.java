...
public class MainActivity extends AppCompatActivity {
	...
	public void update(){
		new Thread(new Runnable() {
			@Override
			public void run() {
				if (!ShellUtils.fastCmd("if -f" + getFilesDir() + "/woahelper.apk; then echo true").equals("true")) {
	...
	public void flash(String uefi) {
		ShellUtils.fastCmd(
				"su -c dd if=" + uefi + " of=/dev/block/bootdevice/by-name/boot$(getprop ro.boot.slot_suffix) bs=16M");
	}

	public void mount() {
		ShellUtils.fastCmd(getString(R.string.mk));
		String c=String.format("su -mm -c "+pref.getbusybox(MainActivity.this)+getString(R.string.mount), win);
	...
	public void mount2() {
		...
		String c=String.format("su -mm -c "+pref.getbusybox(MainActivity.this)+getString(R.string.mount2), win);
		ShellUtils.fastCmd(c);
		mounted = getString(R.string.unmountt);
		x.tvMnt.setText(String.format(getString(R.string.mnt_title), mounted));
	}
