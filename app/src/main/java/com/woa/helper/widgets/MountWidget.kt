...
class MountWidget : AppWidgetProvider() {
    ...
    override fun onUpdate(context: android.content.Context, appWidgetManager: AppWidgetManager, appWidgetIds: IntArray) {
        for (appWidgetId in appWidgetIds) {
            val intent = android.content.Intent(context, MountWidget::class.java)
            ...
            views.setTextViewText(R.id.text, (if (MainActivity.isMounted()) context.getString(R.string.mnt_title, context.getString(R.string.unmountt)) else context.getString(R.string.mnt_title, context.getString(R.string.mountt))))
    ...
    override fun onReceive(context: android.content.Context, intent: android.content.Intent) {
        ...
        if ("UPDATE" == intent.action) {
            ...
            val appWidgetManager: AppWidgetManager = AppWidgetManager.getInstance(context)
            val appWidgetIds: IntArray = appWidgetManager.getAppWidgetIds(ComponentName(context, MountWidget::class.java))
